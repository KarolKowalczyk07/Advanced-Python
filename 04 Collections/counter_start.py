...
def main():
    ...
    c1.update(class2)       # add class 2 to class 1
    print(sum(c1.values()), "students in class 1")

    # TODO: What's the most common name in the two classes?
    print(c1.most_common(3), "are the 3 most common names in both classes")

    # TODO: Separate the classes again
    c1.subtract(class2)     # subtract class 2 from class 1
    print(c1.most_common(3), "are the 3 most common names in class 1")

    # TODO: What's common between the two classes?
    print(c1 & c2)      # logical and == &
