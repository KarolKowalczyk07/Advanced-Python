...
def main():
    ...
    print("Top team: ", tm, wl)     # tm = team, wl = win loss tuple
    ...
    print("Equality Test: ", a==b)      # returns true as both have the same items in the same order
    
    # when comaring an OrderedDict to a regular dictionary, the order doesn't matter
